...
class PasswordStrengthChecker {
  ...
  getStrengthLevel(score) {
    if (score < 20) {
      return exports.PasswordStrength.VeryWeak;
    }
    if (score < 40) {
      return exports.PasswordStrength.Weak;
    }
    if (score < 60) {
      return exports.PasswordStrength.Fair;
    }
    if (score < 75) {
      return exports.PasswordStrength.Good;
    }
    if (score < 90) {
      return exports.PasswordStrength.Strong;
    }
    return exports.PasswordStrength.VeryStrong;
  }
  /**
   * 识别问题
   */
  ...
  getStrengthDescription(strength) {
    switch (strength) {
      case exports.PasswordStrength.VeryWeak:
        return "\u975E\u5E38\u5F31";
      case exports.PasswordStrength.Weak:
        return "\u5F31";
      case exports.PasswordStrength.Fair:
        return "\u4E00\u822C";
      case exports.PasswordStrength.Good:
        return "\u597D";
      case exports.PasswordStrength.Strong:
        return "\u5F3A";
      case exports.PasswordStrength.VeryStrong:
        return "\u975E\u5E38\u5F3A";
      default:
        return "\u672A\u77E5";
    }
...
exports.passwordStrengthChecker = passwordStrengthChecker;
//# sourceMappingURL=password-strength.cjs.map
