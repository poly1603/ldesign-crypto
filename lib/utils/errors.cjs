...
class CryptoError extends Error {
  constructor(message, code = exports.CryptoErrorCode.UNKNOWN_ERROR, algorithm, details) {
    super(message);
...
class EncryptionError extends CryptoError {
  constructor(message, code = exports.CryptoErrorCode.ENCRYPTION_FAILED, algorithm, details) {
...
class DecryptionError extends CryptoError {
  constructor(message, code = exports.CryptoErrorCode.DECRYPTION_FAILED, algorithm, details) {
    super(message, code, algorithm, details);
...
class HashError extends CryptoError {
  constructor(message, code = exports.CryptoErrorCode.HASH_FAILED, algorithm, details) {
    super(message, code, algorithm, details);
    this.name = "HashError";
...
class KeyManagementError extends CryptoError {
  constructor(message, code = exports.CryptoErrorCode.KEY_GENERATION_FAILED, algorithm, details) {
    super(message, code, algorithm, details);
...
class EncodingError extends CryptoError {
  constructor(message, code = exports.CryptoErrorCode.ENCODING_FAILED, algorithm, details) {
    super(message, code, algorithm, details);
...
class RateLimitError extends CryptoError {
  constructor(message, retryAfter, details) {
    super(message, exports.CryptoErrorCode.RATE_LIMIT_EXCEEDED, void 0, details);
...
class ValidationError extends CryptoError {
  constructor(message, field, details) {
    super(message, exports.CryptoErrorCode.INVALID_INPUT, void 0, details);
...
class StorageError extends CryptoError {
  constructor(message, code = exports.CryptoErrorCode.STORAGE_FAILED, details) {
...
class CryptoErrorFactory {
  ...
  static createEncryptionError(message, options) {
    return new EncryptionError(message, options?.code || exports.CryptoErrorCode.ENCRYPTION_FAILED, options?.algorithm, options?.details);
  }
  /**
   * 创建解密错误
   */
  static createDecryptionError(message, options) {
    return new DecryptionError(message, options?.code || exports.CryptoErrorCode.DECRYPTION_FAILED, options?.algorithm, options?.details);
  }
  /**
   * 创建哈希错误
   */
  static createHashError(message, options) {
    return new HashError(message, options?.code || exports.CryptoErrorCode.HASH_FAILED, options?.algorithm, options?.details);
  }
  /**
   * 创建密钥管理错误
   */
  static createKeyManagementError(message, options) {
    return new KeyManagementError(message, options?.code || exports.CryptoErrorCode.KEY_GENERATION_FAILED, options?.algorithm, options?.details);
  }
  /**
   * 创建编码错误
   */
  static createEncodingError(message, options) {
    return new EncodingError(message, options?.code || exports.CryptoErrorCode.ENCODING_FAILED, options?.algorithm, options?.details);
  }
  /**
   * 创建限流错误
   */
  ...
  static createStorageError(message, code, details) {
    return new StorageError(message, code || exports.CryptoErrorCode.STORAGE_FAILED, details);
  }
  /**
   * 从原生错误转换
   */
  static fromNativeError(error, defaultMessage) {
    return new CryptoError(error.message || defaultMessage || "Unknown error", exports.CryptoErrorCode.UNKNOWN_ERROR, void 0, { originalError: error });
  }
}
class ErrorHandler {
  /**
...
exports.CryptoErrorFactory = CryptoErrorFactory;
