...
class ModernCipherUtils {
  ...
  static generateKey(_algorithm = "chacha20") {
    const csprng$1 = new csprng.CSPRNG();
    return csprng$1.randomBytes(32);
  }
  /**
  ...
  static generateNonce(algorithm = "chacha20") {
    ...
    if (algorithm === "chacha20") {
      return csprng$1.randomBytes(12);
    } else {
      return csprng$1.randomBytes(24);
    }
  }
  /**
...
exports.ModernCipherUtils = ModernCipherUtils;
exports.Poly1305 = Poly1305;
exports.XSalsa20 = XSalsa20;
exports.default = modernCiphers;
//# sourceMappingURL=modern-ciphers.cjs.map
