  ...
  encrypt(data, key, options = {}) {
    ...
    try {
      if (algorithm.toUpperCase() !== "AES") {
        throw index.ErrorUtils.createEncryptionError("Authenticated encryption currently only supports AES algorithm", "AEAD");
      }
      const iv = index.RandomUtils.generateIV(16);
      const salt = index.RandomUtils.generateSalt(32);
    ...
    try {
      ...
      if (typeof encryptedResult === "string") {
        try {
          ...
          throw index.ErrorUtils.createDecryptionError("Invalid encrypted data format", "AEAD");
        }
      } else {
...
exports.AuthenticatedEncryption = AuthenticatedEncryption;
exports.authenticatedEncryption = authenticatedEncryption;
exports.decryptJSONWithAuth = decryptJSONWithAuth;
exports.decryptWithAuth = decryptWithAuth;
exports.encryptJSONWithAuth = encryptJSONWithAuth;
exports.encryptWithAuth = encryptWithAuth;
//# sourceMappingURL=authenticated-encryption.cjs.map
