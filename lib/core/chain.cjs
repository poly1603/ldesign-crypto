...
class CryptoChain {
  ...
  encrypt(algorithm, key, options) {
    ...
    try {
      ...
      switch (algorithm.toUpperCase()) {
        case "AES":
          result = aes.aes.encrypt(text, key, options);
          break;
        case "RSA":
          result = rsa.rsa.encrypt(text, key, options);
          break;
        case "DES":
          result = des.des.encrypt(text, key, options);
          break;
        case "3DES":
          result = tripledes.des3.encrypt(text, key, options);
          break;
        case "BLOWFISH":
          result = blowfish.blowfish.encrypt(text, key, options);
          break;
        default:
          throw index.ErrorUtils.createEncryptionError(`Unsupported algorithm: ${algorithm}`, "CHAIN");
      }
      if (!result.success) {
  ...
  decrypt(algorithm, key, options) {
    ...
    try {
      ...
      switch (algorithm.toUpperCase()) {
        case "AES":
          result = aes.aes.decrypt(this.data, key, options);
          break;
        case "RSA":
          result = rsa.rsa.decrypt(this.data, key, options);
          break;
        case "DES":
          result = des.des.decrypt(this.data, key, options);
          break;
        case "3DES":
          result = tripledes.des3.decrypt(this.data, key, options);
          break;
        case "BLOWFISH":
          result = blowfish.blowfish.decrypt(this.data, key, options);
          break;
        default:
          throw index.ErrorUtils.createDecryptionError(`Unsupported algorithm: ${algorithm}`, "CHAIN");
      }
  ...
  base64() {
    ...
    try {
      const text = this.getStringData();
      this.data = encoding.encoding.encode(text, "base64");
      return this;
    } catch (error) {
      this.handleError(error);
      return this;
  ...
  fromBase64() {
    ...
    try {
      const text = this.getStringData();
      this.data = encoding.encoding.decode(text, "base64");
      return this;
    } catch (error) {
      this.handleError(error);
      return this;
  ...
  hex() {
    ...
    try {
      const text = this.getStringData();
      this.data = encoding.encoding.encode(text, "hex");
      return this;
    } catch (error) {
      this.handleError(error);
      return this;
  ...
  fromHex() {
    ...
    try {
      const text = this.getStringData();
      this.data = encoding.encoding.decode(text, "hex");
      return this;
    } catch (error) {
      this.handleError(error);
      return this;
...
exports.CryptoChain = CryptoChain;
exports.chain = chain;
