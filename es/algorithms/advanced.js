 ...
 * ***********************************
 */
import { ValidationUtils, ErrorUtils, RandomUtils } from '../utils/index.js';
  ...
  encrypt(data, key, options = {}) {
    try {
      ...
      if (key.length !== this.KEY_LENGTH * 2) {
        throw ErrorUtils.createEncryptionError(`Invalid key length. Expected ${this.KEY_LENGTH * 2} hex characters`, "ChaCha20");
      }
...
export { AESGCMEncryptor, ChaCha20Encryptor, aesGcm, chacha20 };
